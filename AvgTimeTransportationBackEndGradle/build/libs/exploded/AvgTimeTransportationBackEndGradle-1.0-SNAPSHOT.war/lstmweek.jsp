...
<div id="showPart" style="float: left;">
    <label for="dateInput1" style="margin-left: 50px; margin-top: 50px; margin-bottom: 50px;">
        选择日期：</label>
    <input type="date" value="2017-09-22" id="dateInput1"/>
    <input type="date" value="2017-09-28" id="dateInput2"/>
...
<script type="text/javascript">
    ...
    require(
        ...
        function getOd(ec) {
            ...
            $.ajax({
                type: 'GET',
                url: "http://localhost:8080/index/admin/lstmweek",
                data: "startDate=" + date1 + "&endDate=" + date2 +
                "&startStationName=" + startName + "&endStationName=" + endName,
                dataType: "json",
                success: function (result) {
                    ...
                    if (result) {
                        ...
                        var option = {
                            title : {
                                text: date1 + "~" + date2 + '间旅程时间预测与对比（每天）'
                            },
                            tooltip : {
                                trigger: 'axis'
                            },
